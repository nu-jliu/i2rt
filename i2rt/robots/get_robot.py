...
_ARM_JOINT_LIMITS: dict[ArmType, np.ndarray] = {
    ArmType.YAM: np.array(
        [[-2.618, 3.054], [0.0, 3.142], [0.0, 3.665], [-1.571, 1.571], [-1.571, 1.571], [-2.094, 2.094]]
    ),
    ArmType.YAM_PRO: np.array(
        [[-2.618, 3.054], [0.0, 3.142], [0.0, 3.665], [-1.571, 1.571], [-1.571, 1.571], [-2.094, 2.094]]
    ),
    ArmType.YAM_ULTRA: np.array(
        [[-2.618, 3.054], [0.0, 3.142], [0.0, 3.142], [-1.571, 1.571], [-1.571, 1.571], [-2.094, 2.094]]
    ),
...
_BIG_YAM_HW = _ArmHWConfig(
    ...
    kd=np.array([5.0, 5.0, 5.0, 3.0, 3.0, 1.5]),
